...
<section class="subjects">
  <h1 class="heading" style="color: black;">Announcements</h1>
  <div class="box-container">
...
<section class="subjects" id="announcements" style="background-color: #7d7d7d;">
  <h1 class="heading" style="color: black;">CR Announcements</h1>
  <div class="box-container">
     <div class="announcement">
        <iframe class="announcement1" src="https://docs.google.com/spreadsheets/d/e/2PACX-1vRBO8O3F5wTtOV1FcZoQzVbEu_y5jCvWqhNFQhMLVKyRAvSThz_yF1ihW6ES4DlGDGhotcBWiG0VPZd/pubhtml" style="border:none;" height="400" width="1210"></iframe>
      </div>
  </div>
</section>
...
<div class="subjects">
  <h1 class="heading" style="color: black;">Want to explore more? Find essentials tools  <a href="course.php">here.</a></h1>
</div>
...
<section class="footer">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <a href="course.php" class="link">essentials</a>
